...
\resumeItem{Developed internal software to organize scoring of submissions between course
 ...
 \resumeItem{Graded assignments by studying \textbf{80+ submissions}
 for functionality, testing, and course coding standards}
 
 \resumeItem{Improved \textbf{150+ students'} ability to engineer large-scale, low-level programs by encouraging rigorous testing, building modular architecture, and harnessing existing libraries}
